...
//                 setSuccessMsg("Items added successfully")
//                 setTimeout(() => {
//                     setSuccessMsg(" ");
//                 },3000)
//                 }
...
//         <div className='row bg-success text-white text-center'>
...
//                     {
//                         todos.map((item,index) => <li className='list-group-item d-flex justify-content-between align-items-center bg-info'>
